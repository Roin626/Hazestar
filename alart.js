...
(function (window, document) {
    ...
    Msg.prototype = {
        ...
        _creatElement() {
            ...
            const inputHTML = this.showInput ?
                `<div class="msg-body-input" style="overflow: auto; margin: 5px; padding: 5px">
                    <input id="InputHTML" type="text" style="overflow-x: auto;overflow-y: auto; max-height: 30%" value="${this.input_content}">
                </div>` : "";
